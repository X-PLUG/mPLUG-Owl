...
from serve.ustils import build_logger
...
class ModelWorker:
    ...
    def generate_stream(self, params):
        ...
        sentence = do_generate(prompts=prompt,image_list=images,model=model,tokenizer=tokenizer,img_processor=image_processor)
        ret = {
            "text": sentence,
            "error_code": 0,
        }
