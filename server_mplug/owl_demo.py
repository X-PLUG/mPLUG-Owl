...
from .utils import (add_text, after_process_image, disable_btn,
                    downvote_last_response, enable_btn, flag_last_response,
                    get_inputs, get_window_url_params, init, mplug_owl,
                    regenerate, upvote_last_response)
...
if __name__ == "__main__":
    ...
    model = mplug_owl(device="cuda",checkpoint_path = args.checkpoint_path, tokenizer_path = args.tokenizer_path)
    demo = build_demo()
