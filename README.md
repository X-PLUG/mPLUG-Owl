...
## News
* 🔥 [08.25] **MMBench** Our model is selected into [MMBench](https://opencompass.org.cn/leaderboard-multimodal) by OpenCompass and achieves Rank 1 on MMBench (especially among 7B models). This is the first large-scale evaluation multimodal dataset covering so many ability dimensions.
* 🔥 [07.19] The [**LLaMA-2**](https://ai.meta.com/llama/) version of mPLUG-Owl will be *releasing soon*, which achieves new state-of-the-art performance on various benchmarks compared previous version. Please stay tuned!
